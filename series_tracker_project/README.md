...
> Production-ready ETL система для сбора и анализа данных о сериалах с полным циклом от парсинга до автоматизированной отчетности
...
### HTML версия
[monthly_report_2024_11.html](./examples/monthly_report_2024_11.html) - полный интерактивный отчет
